    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-xl text-center mb-16 max-w-3xl mx-auto">
          Pioneering the future of accounting in Australia with cutting-edge
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <div className="bg-gray-800 bg-opacity-50 p-8 rounded-lg border border-gray-700 hover:border-blue-400 transition-all duration-300">
            ...
            <p className="text-lg mb-4">
              At NumberzInsight, we&apos;re not just accountants – we&apos;re
              innovators, futurists, and partners in your financial journey. Our
              mission is to revolutionize the accounting industry by seamlessly
              blending advanced technology with deep financial expertise.
            </p>
            <p className="text-lg">
              We envision a world where financial management is effortless,
              intuitive, and powered by the latest breakthroughs in AI, quantum
              computing, and blockchain technology. Our team of forward-thinking
              professionals is dedicated to making this vision a reality for
        ...
        <div className="bg-gradient-to-r from-gray-800 to-gray-700 p-8 rounded-lg shadow-xl mb-20 border border-gray-600 hover:border-blue-400 transition-all duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="group">
              ...
              <p>
                Book a face-to-face consultation at one of our offices.
                Experience our cutting-edge facilities and meet our expert team
                in person.
              </p>
            </div>
            <div className="group">
              ...
              <p>
                Connect with us from anywhere using our advanced holographic
                conferencing technology for a truly immersive remote experience.
              </p>
            </div>
            <div className="group">
              <h3 className="text-xl font-semibold mb-3 flex items-center">
              ...
              <p>
                Reach out via email for 24/7 support. Our AI systems ensure
                rapid, accurate responses to your queries, with human oversight
                for complex issues.
              </p>
            </div>
          </div>

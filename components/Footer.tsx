      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          >
            ...
            >
              Revolutionizing financial management with cutting-edge technology
            ...
            <div className="flex space-x-4">
              {socialIcons.map(({ name, icon }) => (
                ...
                >
                  <AnimatedIcon
                    name={icon.name as keyof typeof import("lucide-react")}
                    color="currentColor"
                    size={24}
                    animation="pulse"
                  />
            ...
            <ul className="space-y-3">
              ...
              >
                ...
                <span className="text-gray-300">
                  Unit 41/2 Fastline Rd, Truganina VIC 3029
                </span>
              </MotionLi>
              <MotionLi
                className="flex items-center"
        ...
        >
          <p className="text-gray-400">
            &copy; {new Date().getFullYear()} NumberzInsight. All rights
            reserved.
          </p>
        </MotionDiv>
      </div>
